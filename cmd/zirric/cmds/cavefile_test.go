...
func testCavefile() cavefile.Cavefile {
	return cavefile.Cavefile{
		Package: cavefile.Package{Name: "proj", Source: "file:///proj"},
...
func assertCavefileDoc(t *testing.T, doc cavefileDoc) {
	t.Helper()
	if doc.Name != "proj" || doc.Source != "file:///proj" {
		t.Errorf("got Name=%q Source=%q, want proj/file:///proj", doc.Name, doc.Source)
	}
