...
| ---------- | ----------------------------------------------------------------------------------------------------- |
| **Module** | `arrays`                                                                                              |
| **Source** | [`arrays/arrays.zirr`](https://code.knabel.dev/zirric-lang/zirric/src/branch/main/arrays/arrays.zirr) |

`arrays` operates on the built-in [`Array`](../prelude/index.md#array) type. Every function returns a new array rather than changing the one passed in.
...
- **Functions** — [`slice`](#slice), [`range`](#range), [`concat`](#concat), [`repeat`](#repeat), [`reverse`](#reverse), [`isEmpty`](#isempty), [`first`](#first), [`last`](#last), [`contains`](#contains), [`firstIndexOf`](#firstindexof), [`lastIndexOf`](#lastindexof), [`map`](#map), [`flatMap`](#flatmap), [`filter`](#filter), [`reduce`](#reduce)
...
- [`fun`](../fun/index.md) — the lazy equivalents of `map`, `filter`, `flatMap` and `reduce`.
- [`ranges`](../ranges/index.md) — the range values [`range`](#range) accepts.
- [`dicts`](../dicts/index.md) — the same shape of helpers for `Dict`.
