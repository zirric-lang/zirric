...
<header class="hero">
    ...
    <span class="hljs-title function_">length</span>(value: <span class="hljs-meta">@Countable</span>) <span class="hljs-punctuation">-&gt;</span> <span class="hljs-type">Int</span>
}
...
<span class="hljs-keyword">fn</span> <span class="hljs-title function_">summarize</span>(bag: <span class="hljs-type">Bag</span>) <span class="hljs-punctuation">-&gt;</span> <span class="hljs-type">Result</span> {
    <span class="hljs-keyword declaration_">const</span> length <span class="hljs-operator">=</span> <span class="hljs-title function_">Countable</span>(bag).<span class="hljs-title function_">length</span>(bag)

    <span class="hljs-keyword">return</span> <span class="hljs-keyword">if</span> length <span class="hljs-operator">&gt;</span> <span class="hljs-number">0</span> {
