...
- **Language proposals**: `docs/proposals/ZE-001-base-language.md` (core syntax/semantics) and `docs/proposals/ZE-002-the-cavefile.md` (package manifest + tasks). Recent implemented proposals include `docs/proposals/ZE-002-the-cavefile.md` (Cavefile dependencies and tasks), `docs/proposals/ZE-013-mutability-and-constants.md` (const/var), `docs/proposals/ZE-016-closure-syntax.md` (fn closures), `docs/proposals/ZE-017-type-hints.md` (type hints and is-matching), `docs/proposals/ZE-019-result-and-option-sugar.md` (`?.`, `!.`, `??`, `!!`, `T?` and `T!`), and `docs/proposals/ZE-024-qualified-module-names.md` (every file names its module in full). ZE-011 (`docs/proposals/ZE-011-zirric-cli.md`, the CLI) is still In Progress. For future-facing features, see `docs/proposals/ZE-005-Mixin-Type-Declarations.md` and `docs/proposals/ZE-015-extern-type-constructors.md`.
